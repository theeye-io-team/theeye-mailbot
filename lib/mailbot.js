...
class Message {
  ...
  move () {
    ...
    console.log(`moving message ${this.seqId}`)
    return this.#mailbot.connection.messageMove(this.seqId, this.#mailbot.config.folders.processed)
  }
   ...
   */
  download () {
    return this.#mailbot.connection.download(this.seqId)
  }
